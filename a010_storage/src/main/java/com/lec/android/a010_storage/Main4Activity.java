...
public class Main4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnInsert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if("".equals(name)){
                    tvResult.setText("인서트 실패 - 필수항목 입력하시오.");
                    return;
                }
                ...
                try {
                    ...
                    tvResult.setText("인서트 실패 - 나이는 숫자로 입력하시오");
                }
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if("".equals(name)){
                    tvResult.setText("업데이트 실패 - 필수항목 입력하시오.");
                    return;
                }
                ...
                try {
                    ...
                    tvResult.setText("업데이트 실패 - 나이는 숫자로 입력하시오");
                }
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if ("".equals(name)){
                    tvResult.setText("딜리트 실패 - 삭제할 이름을 입력하시오");
                    return;
                }
    ...
    void update(String name, int age, String address){
        ...
        String msg = String.format("%d개의 업데이트 성공", cnt);
...
/*
   insert() 의 두번째 매개변수 nullColumnHack 의 의미
       ...
       이처럼 입력하는 레코드의 데이터가 빈 경우,
       즉 ContentValues 객체에 put() 메서드로 입력된 값이 없는 경우에는 두 번째 인자인 nullColumnHack 에 문자열로 테이블의 한 컬럼을 지정해줘야 에러 없이 정상적으로 SQL 문이 수행된다.
*/
