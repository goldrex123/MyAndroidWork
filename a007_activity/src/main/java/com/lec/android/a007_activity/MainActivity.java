...
public class MainActivity extends AppCompatActivity {
    ...
    // 액티비가 사용자에게 보여지기 시작할 때 (바로 직전)에 호출
    @Override
    ...
    // 다른 액티비티가 보여질 때 (혹은 다른 액티비티에 의해 가려지기 시작할 때)
    ...
    // 액티비티 소멸전에 호출된다. (주의! onPause 뒤에 호출된다고 간주하지 말것!)
    // outState : <-- 액티비티 정보 저장(백업)하여 나중에 onCreate에서 사용 가능
    @Override
    public void onSaveInstanceState(@NonNull Bundle outState) {
        super.onSaveInstanceState(outState);
        Log.d("myapp", "onSavaInstanceState");
