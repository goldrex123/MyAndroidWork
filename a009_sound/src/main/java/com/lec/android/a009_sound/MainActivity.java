...
public class MainActivity extends AppCompatActivity {
    ...
    // 음향 리소스 id
    private final int[] SOUND_RESOURCE = {R.raw.gun, R.raw.gun2, R.raw.gun3};

    // 음향 id 값
    int [] soundId = new int[SOUND_RESOURCE.length];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP){
            ...
            sp = new SoundPool.Builder().setMaxStreams(10).build(); //최종적으로 build()에서 사운드풀 만듬
        } else {
            sp = new SoundPool(1, // 재생 음향 최대 개수
                    AudioManager.STREAM_MUSIC, // 재생 미디어타입
                    0 // 재생 품질.. (안쓰임, 디폴트0)
            );
        }
        ...
        btnPlay1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sp.play(soundId[0], // 준비한 sound 리소스 id
                        ...
                        1f // 재생 속도 float, 0.5(절반속도) ~ 2.0(2배속)
                );
        ...
        btnPlay2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sp.play(soundId[1], // 준비한 sound 리소스 id
                        ...
                        2f // 재생 속도 float, 0.5(절반속도) ~ 2.0(2배속)
                );
        ...
        btnPlay3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sp.play(soundId[2], // 준비한 sound 리소스 id
                        ...
                        0.5f // 재생 속도 float, 0.5(절반속도) ~ 2.0(2배속)
                );
