...
public class Main2Activity extends AppCompatActivity {
    ...
    protected AlertDialog.Builder showAlert(int id) {
        ...
        switch (id) {
            case DIALOG_TEXT:
                AlertDialog.Builder builder1 = new AlertDialog.Builder(this); //테마 지정은 android 패키지

                builder1.setTitle("다이얼로그 제목").setMessage("안녕들 하쇼")
            ...
            case DIALOG_RADIO:
                ...
                builder3.setTitle("색을 고르세요")
                        .setPositiveButton("선택완료", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                Toast.makeText(getApplicationContext(), "선택은 : " + str2[choice], Toast.LENGTH_LONG).show();
                            }
                        })
                        .setNegativeButton("취소", null)
                        .setSingleChoiceItems(str2, //리스트 배열 목록
                                -1, //기본 설정값
                                new DialogInterface.OnClickListener() {
            ...
            case DIALOG_MULTICHOICE:
                ...
                builder4.setTitle("멀티초이스 다이얼로그")
                        ...
                        .setMultiChoiceItems(data, // 체크박스 리스트 항목
                                checked, // 초기값 (선택여부) 배열
                                new DialogInterface.OnMultiChoiceClickListener() { // 체크박스 선택했을 때 호출되는 콜백
                                    @Override
