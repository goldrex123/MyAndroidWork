...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Dialog 클래스로 다이얼ㄹ그 객체 생성 및 세팅
        dlg1 = new Dialog(this); // 다이얼로그 객체 생성
        dlg1.setContentView(R.layout.dialog_layout11); // 다이얼로그화면 등록
        ...
        btnDlgEvent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ivDlgBanner.setImageResource(R.drawable.face21);
        ...
        dlg1.setCanceledOnTouchOutside(true); // 다이얼로그 바깥 영역클릭시 (혹은 back 버튼 클릭시) hide() 상태가 된다
                                            // 종료할 것인지 여부, true : 종료 false : 종료 안됨
